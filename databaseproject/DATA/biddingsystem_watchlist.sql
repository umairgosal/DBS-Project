...
CREATE TABLE `watchlist` (
  ...
  PRIMARY KEY (`listing`,`user`),
  CONSTRAINT `watchlist_ibfk_1` FOREIGN KEY (`listing`) REFERENCES `listing` (`listing_id`) ON DELETE CASCADE
...
-- Dump completed on 2023-12-21 14:05:24
