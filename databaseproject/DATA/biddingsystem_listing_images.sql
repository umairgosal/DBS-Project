...
CREATE TABLE `listing_images` (
  ...
  CONSTRAINT `listing_images_ibfk_1` FOREIGN KEY (`listing_id`) REFERENCES `listing` (`listing_id`) ON DELETE CASCADE
...
INSERT INTO `listing_images` VALUES (1,'biddingsystem/images/1_bat.jpeg');
...
-- Dump completed on 2023-12-21 14:08:00
