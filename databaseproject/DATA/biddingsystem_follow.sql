...
CREATE TABLE `follow` (
  ...
  CONSTRAINT `follow_ibfk_1` FOREIGN KEY (`follower`) REFERENCES `auth_user` (`username`),
  CONSTRAINT `follow_ibfk_2` FOREIGN KEY (`followed`) REFERENCES `auth_user` (`username`)
...
INSERT INTO `follow` VALUES ('hissan','saadashraf');
...
-- Dump completed on 2023-12-21 14:03:49
